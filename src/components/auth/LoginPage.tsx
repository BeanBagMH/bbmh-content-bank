      ...
      <div className="w-full max-w-[440px] space-y-12 p-12 animate-in fade-in zoom-in duration-700">
        <div className="text-center space-y-4">
          ...
          <div className="flex items-center gap-3 justify-center">
            <span className="px-3 py-1 bg-dark text-white text-[10px] font-black rounded-full uppercase tracking-widest shadow-lg shadow-dark/20 animate-pulse">V3.1.6-ACTIVATED</span>
